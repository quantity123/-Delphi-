...
function TPersonBuilder.GetPersonInfo: string;
begin
  Result := FPersonBodyProperty.GetPersonInfo;
end;
...
begin
  FPersonBodyProperty.Add('≈÷…ÌÃÂ');
end;

procedure TPersonFatBuilder.BuildHead;
begin
  FPersonBodyProperty.Add('≈÷Õ∑');
end;

procedure TPersonFatBuilder.BuildLegLeft;
begin
  FPersonBodyProperty.Add('≈÷◊ÛÕ»');
end;
